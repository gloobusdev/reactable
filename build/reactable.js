    ...
    var BtnPaginator = (function (_React$Component) {
        ...
        _createClass(BtnPaginator, [{
            ...
            value: function renderPrevious() {
                ...
                var canPage = currentPage > 0;
                return _react["default"].createElement("button", { className: "reactable-previous-page " + (canPage ? "" : "disabled"),
            ...
            value: function renderNext() {
                ...
                var canPage = currentPage + 1 !== numPages;
                return _react["default"].createElement("button", { className: "reactable-next-page " + (canPage ? "" : "disabled"),
                    href: pageHref(this.props.currentPage + 1),
            ...
            value: function renderCounter() {
                ...
                var itemsNumber = _props3.itemsNumber;
